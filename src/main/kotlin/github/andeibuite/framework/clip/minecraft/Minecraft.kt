...
) : Serializable
{
	companion object
	{
		...
		{
			return Minecraft( MinecraftStruct.createDefault(), MinecraftAccount.createDefault(), ClipConfig.defaultGameVersion )
		}
	...
	fun toJson(): String = GsonBuilder().disableHtmlEscaping().create().toJson(this)
